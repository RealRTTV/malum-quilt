...
public class EtherWallTorchBlock extends WallTorchBlock implements Waterloggable {
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public EtherWallTorchBlock(Settings settings, ParticleEffect particleEffect) {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        if (superState != null) {
            return superState.with(WATERLOGGED, fluidState.getFluid() == Fluids.WATER);
        }
