...
public interface MalumRegistry { // maps make stuff look cooler ok?
    ...
    // items & blocks, sorted [Malum]
                                             ...
                                             Block SPIRIT_ALTAR                              = registerBlockItem        ("spirit_altar",                              new SpiritAltarBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).sounds(BlockSoundGroup.WOOD).strength(2.0f)), MALUM);
    // spirit jar
    // soul vial
    // runewood obelisk
    // brilliant obelisk
    ...
    // gold impetus
                                            Block ETHER                                     = registerBlockItem        ("ether",                                     new EtherBlock(Settings.of(Material.WOOL).noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD) /* todo: particle */), MALUM);
                                            Block ETHER_TORCH                               = registerBlock            ("ether_torch",                               new EtherTorchBlock(Settings.of(Material.DECORATION).noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD) /* todo: particle */));
                                            Block WALL_ETHER_TORCH                          = registerBlock            ("wall_ether_torch",                          new EtherWallTorchBlock(Settings.of(Material.DECORATION).noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD) /* todo: particle */));
                                             Item ETHER_TORCH_ITEM                          = registerItem             ("ether_torch",                               new WallStandingBlockItem(ETHER_TORCH, WALL_ETHER_TORCH, new Item.Settings().group(MALUM)));
    ...
    // items & blocks, sorted [Malum: Natural Wonders]
                                             Item HOLY_SAP                                  = registerItem             ("holy_sap",                                  new Item(new Item.Settings().group(MALUM)));
                                             Item HOLY_SAPBALL                              = registerItem             ("holy_sapball",                              new Item(new Item.Settings().group(MALUM)));
                                             Item HOLY_SYRUP                                = registerItem             ("holy_syrup",                                new HolySyrupItem(new Item.Settings().group(MALUM).food(new FoodComponent.Builder().statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 0), 1.0f).alwaysEdible().hunger(8).saturationModifier(0.4f).build())));
                                            Block RUNEWOOD_LEAVES                           = registerBlockItem        ("runewood_leaves",                           new GradientLeavesBlock(Settings.of(Material.LEAVES).strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque()), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_SAPLING                          = registerBlockItem        ("runewood_sapling",                          new SaplingBlock(new RunewoodSaplingGenerator(), Settings.of(Material.LEAVES).ticksRandomly().noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_LOG                              = registerBlockItem        ("runewood_log",                              new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block STRIPPED_RUNEWOOD_LOG                     = registerBlockItem        ("stripped_runewood_log",                     new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD                                  = registerBlockItem        ("runewood",                                  new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block STRIPPED_RUNEWOOD                         = registerBlockItem        ("stripped_runewood",                         new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block EXPOSED_RUNEWOOD_LOG                      = registerBlockItem        ("exposed_runewood_log",                      new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block REVEALED_RUNEWOOD_LOG                     = registerBlockItem        ("revealed_runewood_log",                     new RevealedPillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD), HOLY_SAP, STRIPPED_RUNEWOOD_LOG), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS                           = registerBlockItem        ("runewood_planks",                           new Block(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block VERTICAL_RUNEWOOD_PLANKS                  = registerBlockItem        ("vertical_runewood_planks",                  new Block(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PANEL                            = registerBlockItem        ("runewood_panel",                            new Block(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_TILES                            = registerBlockItem        ("runewood_tiles",                            new Block(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS_SLAB                      = registerBlockItem        ("runewood_planks_slab",                      new SlabBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block VERTICAL_RUNEWOOD_PLANKS_SLAB             = registerBlockItem        ("vertical_runewood_planks_slab",             new SlabBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PANEL_SLAB                       = registerBlockItem        ("runewood_panel_slab",                       new SlabBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_TILES_SLAB                       = registerBlockItem        ("runewood_tiles_slab",                       new SlabBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS_STAIRS                    = registerBlockItem        ("runewood_planks_stairs",                    new StairsBlock(RUNEWOOD_PLANKS.getDefaultState(), Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block VERTICAL_RUNEWOOD_PLANKS_STAIRS           = registerBlockItem        ("vertical_runewood_planks_stairs",           new StairsBlock(VERTICAL_RUNEWOOD_PLANKS.getDefaultState(), Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PANEL_STAIRS                     = registerBlockItem        ("runewood_panel_stairs",                     new StairsBlock(RUNEWOOD_PANEL.getDefaultState(), Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_TILES_STAIRS                     = registerBlockItem        ("runewood_tiles_stairs",                     new StairsBlock(RUNEWOOD_TILES.getDefaultState(), Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block CUT_RUNEWOOD_PLANKS                       = registerBlockItem        ("cut_runewood_planks",                       new Block(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_BEAM                             = registerBlockItem        ("runewood_beam",                             new PillarBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_DOOR                             = registerBlock            ("runewood_door",                             new DoorBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque()));
                                            ...
                                            Block RUNEWOOD_TRAPDOOR                         = registerBlockItem        ("runewood_trapdoor",                         new TrapdoorBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()), MALUM_NATURAL_WONDERS);
                                            Block SOLID_RUNEWOOD_TRAPDOOR                   = registerBlockItem        ("solid_runewood_trapdoor",                   new TrapdoorBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS_BUTTON                    = registerBlockItem        ("runewood_planks_button",                    new WoodenButtonBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS_PRESSURE_PLATE            = registerBlockItem        ("runewood_planks_pressure_plate",            new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS_FENCE                     = registerBlockItem        ("runewood_planks_fence",                     new FenceBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_PLANKS_FENCE_GATE                = registerBlockItem        ("runewood_planks_fence_gate",                new FenceGateBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_ITEM_STAND                       = registerBlockItem        ("runewood_item_stand",                       new ItemStandBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_ITEM_PEDESTAL                    = registerBlockItem        ("runewood_item_pedestal",                    new WoodenItemPedestalBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block RUNEWOOD_SIGN                             = registerBlock            ("runewood_sign",                             new SignBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).noCollision().sounds(BlockSoundGroup.WOOD), RUNEWOOD_SIGN_TYPE));
                                            Block RUNEWOOD_WALL_SIGN                        = registerBlock            ("runewood_wall_sign",                        new WallSignBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).noCollision().sounds(BlockSoundGroup.WOOD), RUNEWOOD_SIGN_TYPE));
                                            ...
                                            Block SOULWOOD_LEAVES                           = registerBlockItem        ("soulwood_leaves",                           new GradientLeavesBlock(Settings.of(Material.LEAVES).strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(Blocks::canSpawnOnLeaves).suffocates(Blocks::never).blockVision(Blocks::never)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_SAPLING                          = registerBlockItem        ("soulwood_sapling",                          new SaplingBlock(new SoulwoodSaplingGenerator(), Settings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_LOG                              = registerBlockItem        ("soulwood_log",                              new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block STRIPPED_SOULWOOD_LOG                     = registerBlockItem        ("stripped_soulwood_log",                     new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD                                  = registerBlockItem        ("soulwood",                                  new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block STRIPPED_SOULWOOD                         = registerBlockItem        ("stripped_soulwood",                         new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block EXPOSED_SOULWOOD_LOG                      = registerBlockItem        ("exposed_soulwood_log",                      new PillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block REVEALED_SOULWOOD_LOG                     = registerBlockItem        ("revealed_soulwood_log",                     new RevealedPillarBlock(Settings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD), UNHOLY_SAP, STRIPPED_SOULWOOD_LOG), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS                           = registerBlockItem        ("soulwood_planks",                           new Block(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block VERTICAL_SOULWOOD_PLANKS                  = registerBlockItem        ("vertical_soulwood_planks",                  new Block(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PANEL                            = registerBlockItem        ("soulwood_panel",                            new Block(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_TILES                            = registerBlockItem        ("soulwood_tiles",                            new Block(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS_SLAB                      = registerBlockItem        ("soulwood_planks_slab",                      new SlabBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block VERTICAL_SOULWOOD_PLANKS_SLAB             = registerBlockItem        ("vertical_soulwood_planks_slab",             new SlabBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PANEL_SLAB                       = registerBlockItem        ("soulwood_panel_slab",                       new SlabBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_TILES_SLAB                       = registerBlockItem        ("soulwood_tiles_slab",                       new SlabBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS_STAIRS                    = registerBlockItem        ("soulwood_planks_stairs",                    new StairsBlock(SOULWOOD_PLANKS.getDefaultState(), Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block VERTICAL_SOULWOOD_PLANKS_STAIRS           = registerBlockItem        ("vertical_soulwood_planks_stairs",           new StairsBlock(VERTICAL_SOULWOOD_PLANKS.getDefaultState(), Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PANEL_STAIRS                     = registerBlockItem        ("soulwood_panel_stairs",                     new StairsBlock(SOULWOOD_PANEL.getDefaultState(), Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_TILES_STAIRS                     = registerBlockItem        ("soulwood_tiles_stairs",                     new StairsBlock(SOULWOOD_TILES.getDefaultState(), Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block CUT_SOULWOOD_PLANKS                       = registerBlockItem        ("cut_soulwood_planks",                       new Block(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_BEAM                             = registerBlockItem        ("soulwood_beam",                             new PillarBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_DOOR                             = registerBlock            ("soulwood_door",                             new DoorBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque()));
                                            ...
                                            Block SOULWOOD_TRAPDOOR                         = registerBlockItem        ("soulwood_trapdoor",                         new TrapdoorBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()), MALUM_NATURAL_WONDERS);
                                            Block SOLID_SOULWOOD_TRAPDOOR                   = registerBlockItem        ("solid_soulwood_trapdoor",                   new TrapdoorBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS_BUTTON                    = registerBlockItem        ("soulwood_planks_button",                    new WoodenButtonBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS_PRESSURE_PLATE            = registerBlockItem        ("soulwood_planks_pressure_plate",            new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS_FENCE                     = registerBlockItem        ("soulwood_planks_fence",                     new FenceBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_PLANKS_FENCE_GATE                = registerBlockItem        ("soulwood_planks_fence_gate",                new FenceGateBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_ITEM_STAND                       = registerBlockItem        ("soulwood_item_stand",                       new ItemStandBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_ITEM_PEDESTAL                    = registerBlockItem        ("soulwood_item_pedestal",                    new WoodenItemPedestalBlock(Settings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)), MALUM_NATURAL_WONDERS);
                                            Block SOULWOOD_SIGN                             = registerBlock            ("soulwood_sign",                             new SignBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).noCollision().sounds(BlockSoundGroup.WOOD), SOULWOOD_SIGN_TYPE));
                                            Block SOULWOOD_WALL_SIGN                        = registerBlock            ("soulwood_wall_sign",                        new WallSignBlock(Settings.of(Material.WOOD, MapColor.DIRT_BROWN).strength(2.0f, 3.0f).noCollision().sounds(BlockSoundGroup.WOOD), SOULWOOD_SIGN_TYPE));
    ...
    // items & blocks, sorted [Malum: Spirits]
                                            ...
                                            Block BLOCK_OF_ARCANE_CHARCOAL                  = registerBlockItem        ("block_of_arcane_charcoal",                  new Block(Settings.of(Material.STONE, MapColor.BLACK).strength(5.0f, 6.0f).sounds(BLOCK_ARCANE_CHARCOAL_SOUNDS)), MALUM);
                                             Item ARCANE_CHARCOAL                           = registerItem             ("arcane_charcoal",                           new Item(new Item.Settings().group(MALUM)));
    ...
    // block entities
         ...
         BlockEntityType<ItemPedestalBlockEntity> ITEM_PEDESTAL_BLOCK_ENTITY                = registerBlockEntity      ("item_pedestal",                             BlockEntityType.Builder.create(ItemPedestalBlockEntity::new, RUNEWOOD_ITEM_PEDESTAL, SOULWOOD_ITEM_PEDESTAL, TAINTED_ROCK_ITEM_PEDESTAL, TWISTED_ROCK_ITEM_PEDESTAL).build(null));
          BlockEntityType<SpiritAltarBlockEntity> SPIRIT_ALTAR_BLOCK_ENTITY                 = registerBlockEntity      ("spirit_altar",                              BlockEntityType.Builder.create(SpiritAltarBlockEntity::new, SPIRIT_ALTAR).build(null));
                BlockEntityType<EtherBlockEntity> ETHER_BLOCK_ENTITY                        = registerBlockEntity      ("ether",                                     BlockEntityType.Builder.create(EtherBlockEntity::new, ETHER, ETHER_TORCH, WALL_ETHER_TORCH).build(null));
