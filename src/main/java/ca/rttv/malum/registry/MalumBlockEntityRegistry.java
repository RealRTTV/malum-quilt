...
public interface MalumBlockEntityRegistry {
    ...
    BlockEntityType<SpiritCatalyzerBlockEntity> SPIRIT_CATALYZER_BLOCK_ENTITY  = registerBlockEntity("spirit_catalyzer",  BlockEntityType.Builder.create(SpiritCatalyzerBlockEntity::new, SPIRIT_CATALYZER).build(null));
