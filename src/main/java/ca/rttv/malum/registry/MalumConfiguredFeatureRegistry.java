...
public interface MalumConfiguredFeatureRegistry {
    ...
    Holder<ConfiguredFeature<OreFeatureConfig, ?>>     LOWER_ORE_SOULSTONE_CONFIGURED       = register("lower_ore_soulstone", Feature.ORE, new OreFeatureConfig(SOULSTONE_ORE_TARGETS, CommonConfig.UNDERGROUND_SOULSTONE_VEIN_AMOUNT));
    Holder<ConfiguredFeature<OreFeatureConfig, ?>>     UPPER_ORE_SOULSTONE_CONFIGURED       = register("upper_ore_soulstone", Feature.ORE, new OreFeatureConfig(SOULSTONE_ORE_TARGETS, CommonConfig.SURFACE_SOULSTONE_VEIN_AMOUNT));
    Holder<ConfiguredFeature<OreFeatureConfig, ?>>     ORE_BRILLIANCE_CONFIGURED            = register("ore_brilliance",      Feature.ORE, new OreFeatureConfig(BRILLIANCE_ORE_TARGETS, CommonConfig.BRILLIANT_STONE_VEIN_SIZE));
    Holder<ConfiguredFeature<OreFeatureConfig, ?>>     BLAZING_QUARTZ_CONFIGURED            = register("blazing_quartz",      Feature.ORE, new OreFeatureConfig(BLAZING_QUARTZ_TARGETS, CommonConfig.BLAZING_QUARTZ_VEIN_SIZE));
